...
def change_tempo(midi_file_path, new_bpm, original_bpm):
...
if __name__ == '__main__':
    ...
    with data_path.open() as file:
        ...
        midi_data_path = data_folder_path / "drummer9/session1/1_rock_100_beat_4-4.mid"
        midi_file = midi_data_path

        new_path = change_tempo(midi_file, 120, 100)
